...
void makeSeuss::writeFile() {
    ...
    outfile.close();
    cout << "Collisions for this configuration:" << endl;
    cout<< "Original Collisions (collisionct1):"<<ht->collisionct1<<endl;
    cout<<"Post Collisions (collisionct2):"<<ht->collisionct2<<endl;
}
